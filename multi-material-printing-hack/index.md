...
In the same spirit as [an earlier post](/extending-the-mk3s-print-area/), here is a quick hack I used to get my **dual**-headed Prusa XL printer to print with **three** materials at once.
...
![The shaded blue area is meant to be TPU/FLEX material. The shaded yellow area is meant to be ABS material.](https://karlquinsland.com/multi-material-printing-hack/images/ball_sa_01.webp)

_The shaded blue area is meant to be TPU/FLEX material. The shaded yellow area is meant to be ABS material._
...
![Grey is TPU, Green is ABS, and the Blue/Grey mix is the support material composed of interleaved PLA and TPU layers.](https://karlquinsland.com/multi-material-printing-hack/images/ball_slicer_01.webp)

_Grey is TPU, Green is ABS, and the Blue/Grey mix is the support material composed of interleaved PLA and TPU layers._
...
![This is the 'per-layer' view from the slicer with a 'bottom-up' perspective. As before, Grey is TPU, Green is ABS, and the thin blue circle represents the topmost layer of the support material.](https://karlquinsland.com/multi-material-printing-hack/images/ball_slicer_02.webp)

_This is the 'per-layer' view from the slicer with a 'bottom-up' perspective. As before, Grey is TPU, Green is ABS, and the thin blue circle represents the topmost layer of the support material._
...
![Prusa XL refusing to start the print because it knows I'm trying to cheat.](https://karlquinsland.com/multi-material-printing-hack/images/printer_01.webp)

_Prusa XL refusing to start the print because it knows I'm trying to cheat._
